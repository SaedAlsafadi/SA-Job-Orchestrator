...
async def run_smoke_test(url: str):
    print(f"=== Real Greenhouse Smoke Test ===")
    print(f"URL: {url}")
    ...
    async with async_playwright() as p:
        ...
        try:
            ...
            screenshot_path = "data/storage/screenshots/greenhouse_smoke_test.png"
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Real Greenhouse Smoke Test")
    parser.add_argument("url", help="Public Greenhouse Job URL")
